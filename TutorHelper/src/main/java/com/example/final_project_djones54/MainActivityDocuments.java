...
public class MainActivityDocuments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_documents);
        ...
        //findViewById(R.id.downloadButton_doc).setOnClickListener(view -> downloadFile());
        backbutton = (Button) findViewById(R.id.backButton_doc);
    ...
    private void openFilePicker() {
        System.out.println("File picker called");
    ...
    private void createFile() {
        if (mDriveServiceHelper != null) {
            ...
            Toast.makeText(getApplicationContext(), "Creating a file.",
    ...
    private void saveFile() {
        if (mDriveServiceHelper != null && mOpenFileId != null) {
            ...
            Toast.makeText(getApplicationContext(), "Saving " + mOpenFileId,
                    Toast.LENGTH_LONG).show();
    ...
    {
        if(mOpenFileId != null) {
            mDriveServiceHelper.downloadFile(1, mOpenFileId);
        }
    }
